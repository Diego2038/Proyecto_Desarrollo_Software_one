 ...
 * @author Diego
 */
public class CrudSedeController extends CrudSQL implements Initializable {
    ...
    public void accionBoton(ActionEvent ae){
        if (ae.getSource() == btn_guardar_usuario) {
            ...
            try {
                if (verificadorSizeCelda(txt_ciudad, 4, 100) && verificadorSizeCelda(txt_nombre, 5, 150)
                        && verificadorSizeCelda(txt_direccion, 5, 150)) {

                    crud_registrar("sede", "nombre", "ciudad", "direccion", txt_nombre.getText().trim(), 
                            txt_ciudad.getText().trim(), txt_direccion.getText().trim());
    ...
    public String seleccionarValor(String nombre){
        ...
        if("nombre".equals(nombre)){
            ...
            resultado = txt_ciudad.getText().trim();
        }else if("direccion".equals(nombre)){
            resultado = txt_direccion.getText().trim();
        }
        return resultado;
    }
    ...
    public String seleccionarValorSegundaColumna(String nombre){
        ...
        if("nombre".equals(nombre)){
            ...
            resultado = txt_ciudad_condicion.getText().trim();
        }else if("direccion".equals(nombre)){
            resultado = txt_direccion_condicion.getText().trim();
        }
        return resultado;
    }
