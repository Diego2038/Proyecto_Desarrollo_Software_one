 ...
 * @author Diego
 */
public class AutorizacionTrasladoVehiculoController extends CrudSQL implements Initializable {
    ...
    public void accionBoton(ActionEvent ae){
        if(ae.getSource()==btn_buscar_usuario){
            ...
            try {
                //>>>>//
                crud_modificar_manual("tramite_de_traslado", "estado='"+cb_estado.getValue().trim()+"'", CONDICION);
                info.setText("Solicitud calificada exitosamente");
            } catch (SQLException ex) {
